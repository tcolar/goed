...
var _resResources_versionTxt = []byte("\x1f\x8b\x08\x00\x00\x09\x6e\x88\x00\xff\x32\x34\xb1\xb4\xb4\x34\x30\xb2\x30\x30\xe6\x02\x04\x00\x00\xff\xff\x97\x8c\x41\x1c\x0b\x00\x00\x00")
...
func resResources_versionTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "res/resources_version.txt", size: 11, mode: os.FileMode(420), modTime: time.Unix(1499902803, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
